...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, dz.a3bc.stock.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, dz.a3bc.stock.repository.UserRepository.USERS_BY_EMAIL_CACHE);
